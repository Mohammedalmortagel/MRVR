...
async def almortagel():
   almortagell = [
    "كالغيثِ ذكرُكَ يا حبيبي لمْ يزلْ يسقي القلوبَ محبَّةً ونعيمَا - يا سيدَ الثقلينِ حُزتَ مكانةً ومقامَ عزٍّ في النفوسِ عظيمَا - يا مَنْ سلكتُمْ نهجهُ وسبيلهُ٠🌿❤",
